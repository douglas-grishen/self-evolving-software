...
const INFRA_NODES = [
  { id: "engine", label: "Engine", icon: "🔁", color: "#3b82f6", desc: "MAPE-K loop · Claude LLM" },
...
export function ArchitectureView() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20, height: "100%" }}>
      ...
      <div>
        <div style={{ fontSize: "0.7rem", color: "#666", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 10, fontWeight: 500 }}>
          Infrastructure
        </div>
      ...
      <div style={{ flex: 1, overflow: "auto" }}>
        ...
        {loading && apps.length === 0 ? (
          ...
          <div className="empty-state">No apps yet — the engine will create them autonomously.</div>
        ) : (
